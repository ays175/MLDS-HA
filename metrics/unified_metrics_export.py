    ...
    def _generate_trend_insights(self, cross_trends: Dict, df: pd.DataFrame, platform: str) -> Dict[str, Any]:
        ...
        if "brand_trends" in cross_trends:
            ...
            for brand, data in cross_trends["brand_trends"].items():
                if data["engagement_trend"]["direction"] == "increasing":
                    brand_insights.append(f"{brand}: {data['engagement_trend']['percentage_change']:.1f}% engagement growth")
                elif data["engagement_trend"]["direction"] == "decreasing":
                    declining_brands.append(f"{brand}: {data['engagement_trend']['percentage_change']:.1f}% engagement decline")
        ...
        if "country_trends" in cross_trends:
            ...
            for country, data in cross_trends["country_trends"].items():
                if data["engagement_trend"]["direction"] == "increasing":
                    country_insights.append(f"{country}: {data['engagement_trend']['percentage_change']:.1f}% engagement growth")
                elif data["engagement_trend"]["direction"] == "decreasing":
                    declining_countries.append(f"{country}: {data['engagement_trend']['percentage_change']:.1f}% engagement decline")
        ...
        if "content_type_trends" in cross_trends:
            ...
            for content_type, data in cross_trends["content_type_trends"].items():
                if data["engagement_trend"]["direction"] == "increasing":
                    content_insights.append(f"{content_type}: {data['engagement_trend']['percentage_change']:.1f}% engagement growth")
                elif data["engagement_trend"]["direction"] == "decreasing":
                    declining_content.append(f"{content_type}: {data['engagement_trend']['percentage_change']:.1f}% engagement decline")
